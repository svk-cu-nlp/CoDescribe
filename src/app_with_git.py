...
def initialize_robot(project_name):
    ...
    # folder = st.session_state.project
    # print(" The Link is "+ str(folder))
    loader = GitLoader(
    clone_url=git_link,
...
def clone_project(git_link):
    ...
    # loader = GitLoader(repo_path='./example_data/test_repo2/', file_filter=lambda file_path: file_path.endswith(".ipynb"))
    # data = loader.load()
...
st.title("Step 2: Clone a Project")
git_link = st.text_input("Enter GitHub link to upload")
# if st.button("Clone Project"):
#     clone_project(git_link)
# File Upload
...
st.write("If you modified the project and newly cloned your project, please start the chatbot again")
